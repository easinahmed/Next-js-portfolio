...
export default function About() {
    return (
        <section className="about my-[100px] mx-[20px] md:my-[160px] md:mx-[50px] lg:mx-[150px] xl:mx-[200px]" id="about">
            <p className="text-[13px] text-gray-700 pb-[30px] uppercase tracking-wider">About Me</p>
            ...
            <div className="hrrr w-[30%] pb-[40px]">
            ...
            <div className="about-container flex flex-col md:flex-row gap-8 items-center">
                <div className="info-about flex flex-col flex-1">
                    ...
                    <h2 className="pb-[30px] text-xl font-semibold">What Drives Me</h2>
                    <div className="card flex gap-4 md:gap-8 flex-wrap">
                        <div className="c1 flex flex-col items-center justify-center text-center border-2 border-black px-5 py-4 rounded-[10px] transition-all duration-300 hover:-translate-y-1.5 hover:scale-105 hover:border-[#ff3333] hover:bg-[#fff5f5] hover:shadow-lg cursor-pointer flex-1 min-w-[120px]">
                            <h3 className="pt-2.5 pb-2.5 font-bold"><i className="fa-solid fa-code mb-2 block text-2xl"></i> Languages</h3>
                            <p className="text-sm">HTML, CSS, JS, Java, C, React</p>
                        </div>
                        <div className="c1 flex flex-col items-center justify-center text-center border-2 border-black px-5 py-4 rounded-[10px] transition-all duration-300 hover:-translate-y-1.5 hover:scale-105 hover:border-[#ff3333] hover:bg-[#fff5f5] hover:shadow-lg cursor-pointer flex-1 min-w-[120px]">
                            <h3 className="pt-2.5 pb-2.5 font-bold"><i className="fa-solid fa-graduation-cap mb-2 block text-2xl"></i> Education</h3>
                            <p className="text-sm">USTHB in Computer Science</p>
                        </div>
                        <div className="c1 flex flex-col items-center justify-center text-center border-2 border-black px-5 py-4 rounded-[10px] transition-all duration-300 hover:-translate-y-1.5 hover:scale-105 hover:border-[#ff3333] hover:bg-[#fff5f5] hover:shadow-lg cursor-pointer flex-1 min-w-[120px]">
                ...
                <div className="flex-1 w-full max-w-[400px] mt-8 md:mt-0 relative">
                    <Image
                        src="/images/img.jpg"
                        alt="About Image"
                        width={400}
                        height={400}
                        className="rounded-[15px] border border-black w-full h-auto object-cover md:relative md:-bottom-[85px]"
                    />
                </div>
            </div>
        </section>
