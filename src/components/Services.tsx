...
export default function Services() {
    return (
        <section className="services my-[100px] mx-[20px] md:my-[160px] md:mx-[50px] lg:mx-[150px] xl:mx-[200px] flex flex-col items-center justify-center text-center" id="services">
            ...
            <div className="services-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1100px] w-full mx-auto pt-[30px]">
                {services.map((service, index) => (
                    <div key={index} className="service-card bg-white p-6 rounded-2xl shadow-md transition-all duration-500 text-center relative overflow-hidden group hover:shadow-xl">
                        ...
                        <div className="absolute top-0 left-[-100%] w-full h-full bg-[#474af0] z-0 transition-all duration-500 group-hover:left-0"></div>
                        ...
                        <div className="z-10 relative">
                            <Image
                                ...
                                width={100}
                                height={100}
                                className="mb-4 mx-auto w-[100px] h-[100px]"
                            />
